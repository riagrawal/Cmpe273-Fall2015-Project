...
*/
		...
		Jedis master = new Jedis("127.0.0.1",6376);
		Jedis slave = new Jedis("127.0.0.1",6375);
		...
		//System.out.println("Enter name of the string : ");
			
		//System.out.println("Enter value of"+st1+": ");
		//String st2 = st.nextLine();
